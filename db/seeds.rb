...
userarray= [{name:"Alok",email:"mkara34@gmail.com",phone:7757844500,role:"hr"},
                {name:"Anurag",email:"anurag@gmail.com",phone:9696874510,role:"coustomer assosiate"},
                {name:"Amit",email:"amit@gmail.com",phone:7757892500,role:"SDE"},
                {name:"Deepa",email:"deepa@gmail.com",phone:7757896341,role:"Manager"}]
userarray.each do |user|
  company1.users.find_or_create_by(user)
end