...
#   Character.create(name: 'Luke', movie: movies.first)
   ...
   # company1.addresses.find_or_create_by({house_no:"GHIB92",locality:"kupwad",city:"Sangli",state:"Maharashtra",pincode:416415})
   # company2.addresses.find_or_create_by({house_no:"WNIB42",locality:"Kharadi",city:"Panji",state:"Goa",pincode:411045})
   # company3.addresses.find_or_create_by({house_no:"WNk086",locality:"Aagarkar Nagar",city:"Indore",state:"Madhya Pradesh",pincode:419045})
   # company4.addresses.find_or_create_by({house_no:"WYKJK2",locality:"Majage Nagar",city:"Pune",state:"Maharashtra",pincode:411045})
   # company5.addresses.find_or_create_by({house_no:"WNIB42",locality:"Vishrambag",city:"Solapur",state:"Maharashtra",pincode:418945})
